...
3.  Select `Install from Internet` and click
4.  Install for `All Users` in `C:\cygwin`
5.  The local package directory can be the standard download directory:
    [C:/Users/Jon Lighthall/Downloads](run:C:/Users/Jon Lighthall/Downloads)
...
creates `Bash Prompt Here` entry in context menu and an
