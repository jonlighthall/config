...
if [ ! -z "$(command -v __git_ps1)" ]; then
	...
	if [ -z "$PGI" ]; then
	    ...
	    export PS1='\e[0;37m\A\[\e[0;32m\] \u@\[\e[1;34m\]\h\[\e[0;33m\] \w\[\e[0;32m\]\e[36m$(git_branch)\n\e[1;32m$\[\e[0m\] ' # pre time, new line, no brackets, highlight host, git bash color
	else
	    echo "creating PGI prompt..."
	    TEXT='PGI'
	    ...
	    export PS1='\e[0;37m\A\[\e[1;32m\] \u@\[\e[1;35m\]\h\[\e[1;34m\] \e[0;35m\]$TEXT\[\e[0;33m\] \w\[\e[0;32m\]\e[36m$(git_branch)\n\e[1;32m$\[\e[0m\] ' # pre time, new line with text, no brackets, highlight host
	fi
    else
